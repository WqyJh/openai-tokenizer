...
# WARNING: Ensure imports from `openai_tokenizer` comes after this line
from openai_tokenizer import app, settings, db  # noqa
from openai_tokenizer.cli import create_user, cli  # noqa
